...
{
    [Authorize]
    public class __ManageController : Controller
    {
        private ApplicationSignInManager _signInManager;
        private ApplicationUserManager _userManager;

        public __ManageController()
        {
        }

        public __ManageController(ApplicationUserManager userManager, ApplicationSignInManager signInManager)
        {
        ...
        public ActionResult LinkLogin(string provider)
        {
            ...
            return new __AccountController.ChallengeResult(provider, Url.Action("LinkLoginCallback", "Manage"), User.Identity.GetUserId());
        }
